...
SCENARIO_PRESETS: Dict[str, ScenarioPreset] = {
    ...
    "challenge_stealth": ScenarioPreset(
        scenario_id="challenge_stealth",
        description="Challenge preset: Small faint beacon under severe noise and low contrast",
    ...
    "challenge_maneuver": ScenarioPreset(
        scenario_id="challenge_maneuver",
        description="Challenge preset: High dynamic maneuver trajectory with moderate disturbances",
    ...
    "challenge_heavy_jitter": ScenarioPreset(
        scenario_id="challenge_heavy_jitter",
        description="Challenge preset: High amplitude camera jitter and platform motion",
        trajectory_type="figure8",
        target_size_px=10,
        gaussian_sigma=10.0,
        salt_pepper_amount=0.01,
    ...
    "challenge_occlusion": ScenarioPreset(
        scenario_id="challenge_occlusion",
        description="Challenge preset: Multiple distractor optical spots in sensor FOV",
        trajectory_type="random",
        target_size_px=8,
        gaussian_sigma=12.0,
        salt_pepper_amount=0.02,
